...
export const RETRO_FORMATS = {
  ...
  'dod': {
    ...
    emoji: '✅',
    description: 'Vérifier que chaque critère de la Definition of Done est respecté.',
    cols: [
      { key: 'code',          label: 'Code',          color: '#4ade80', dim: 'rgba(74,222,128,0.1)',   border: 'rgba(74,222,128,0.25)',   sub: 'Qualité et revue du code' },
      { key: 'tests',         label: 'Tests',          color: '#60a5fa', dim: 'rgba(96,165,250,0.1)',   border: 'rgba(96,165,250,0.25)',   sub: 'Tests écrits et passants' },
      { key: 'revue',         label: 'Revue',          color: '#a78bfa', dim: 'rgba(167,139,250,0.12)', border: 'rgba(167,139,250,0.3)',   sub: 'Revue effectuée' },
      { key: 'documentation', label: 'Documentation',  color: '#facc15', dim: 'rgba(250,204,21,0.1)',   border: 'rgba(250,204,21,0.25)',   sub: 'Documentation à jour' },
      { key: 'deploiement',   label: 'Déploiement',    color: '#fb923c', dim: 'rgba(251,146,60,0.1)',   border: 'rgba(251,146,60,0.25)',   sub: 'Déployé et vérifié' },
    ],
  },
} as const;
